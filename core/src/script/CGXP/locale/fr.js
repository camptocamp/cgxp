...
GeoExt.Lang.add("fr", {
   ...
   "cgxp.FullTextSearch.prototype": {
    ...
    "cgxp.plugins.Editing.prototype": {
        ...
        cutActionText: "Couper la géométrie",
        cutWizardTitle: "Couper le polygone",
        cutWizardSubtitle: "Choisir le polygone B&nbsp;:",
        cutWizardSelectButtonText: "Sélectionner sur la carte",
        cutWizardDrawButtonText: "Dessiner un polygone",
    ...
    "cgxp.tree.LayerTree.prototype": {
        ...
        datepickerrangeText: "Veuillez sélectionner une date de début et de fin <br>" +
            "dans la période du {from} au {to}.",
        datepickersingleText: "Veuillez sélectionner une date dans la " +
